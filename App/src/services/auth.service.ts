class AuthService {
    ...
    async getSession(): Promise<{
        ...
        const response = await fetch(this.appUrl + "/api/auth/get-session", {
            method: "GET", headers: {
                "Content-Type": "application/json",
            }, credentials: "include",
        });
    ...
    async verifyEmail(token: string, callbackURL?: string): Promise<{ user: any; status: boolean }> {
        ...
        const response = await fetch(`/api/auth/verify-email?${params.toString()}`, {
            method: "GET", headers: {
                "Content-Type": "application/json",
            },
        });
    ...
    async sendVerificationEmail(email: string, callbackURL?: string): Promise<{ status: boolean }> {
        const response = await fetch(this.appUrl + "/api/auth/send-verification-email", {
            method: "POST", headers: {
                ...
                email, callbackURL: callbackURL || null,
            }),
        });
    ...
    async changeEmail(newEmail: string, callbackURL?: string): Promise<{ status: boolean; message: string }> {
        const response = await fetch(this.appUrl + "/api/auth/change-email", {
            method: "POST", headers: {
                ...
                newEmail, callbackURL: callbackURL || null,
            }),
        });
    ...
    async resetPasswordWithToken(token: string, callbackURL?: string): Promise<{ token: string }> {
        ...
        const response = await fetch(`/api/auth/reset-password/${token}${params.toString() ? "?" + params.toString() : ""}`, {
            method: "GET", headers: {
                "Content-Type": "application/json",
            },
        });
    ...
    async listAccounts(): Promise<{
        ...
        const response = await fetch(this.appUrl + "/api/auth/list-accounts", {
            method: "GET", headers: {
                "Content-Type": "application/json",
            },
        });
    ...
    async deleteUserCallback(token: string, callbackURL?: string): Promise<{ success: boolean; message: string }> {
        ...
        const response = await fetch(`/api/auth/delete-user/callback?${params.toString()}`, {
            method: "GET", headers: {
                "Content-Type": "application/json",
            },
        });
    ...
    async unlinkAccount(providerId: string, accountId?: string): Promise<{ status: boolean }> {
        const response = await fetch(this.appUrl + "/api/auth/unlink-account", {
            method: "POST", headers: {
                ...
                providerId, accountId: accountId || null,
            }),
        });
    ...
    async refreshToken(providerId: string, accountId?: string, userId?: string): Promise<{
        ...
        const response = await fetch(this.appUrl + "/api/auth/refresh-token", {
            method: "POST", headers: {
                ...
                providerId, accountId: accountId || null, userId: userId || null,
            }),
        });
    ...
    async checkApiStatus(): Promise<{ ok: boolean }> {
        const response = await fetch(this.appUrl + "/api/auth/ok", {
            method: "GET", headers: {
                "Content-Type": "application/json",
            },
        });
