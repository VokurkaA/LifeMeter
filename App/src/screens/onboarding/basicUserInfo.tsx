...
export interface BasicUserInfoData {
...
export function BasicUserInfo({ onSubmit }: { onSubmit: (data: BasicUserInfoData) => void }) {
  ...
  const validateAndSubmit = () => {
    ...
    const formData: BasicUserInfoData = {
      preferredUnit,
    ...
    <KeyboardAvoidingView behavior="padding" className="flex-1">
      <View className="mt-8 flex-1">
        ...
        <Select
          ...
          value={userSex}
          onChange={(val) => setUserSex(val as BasicUserInfoData['sex'])}
        />
      </View>
