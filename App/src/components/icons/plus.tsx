...
export default function PlusIcon({
  ...
  return (
    <Svg
      ...
      {...rest}
    >
      <Line x1="12" y1="5" x2="12" y2="19" stroke={strokeValue} strokeWidth={strokeWidth} strokeLinecap="round" />
      <Line x1="5" y1="12" x2="19" y2="12" stroke={strokeValue} strokeWidth={strokeWidth} strokeLinecap="round" />
    </Svg>
  );
}
