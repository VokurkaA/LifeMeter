...
function DialogContent({
    ...
    return (<Modal
        ...
        >
            ...
            >
                <View className="flex items-center justify-center flex-1 bg-black/75">
                    <TouchableOpacity
                        className={cn('border border-border bg-card rounded-2xl p-6 shadow-lg mx-6 min-w-72', className)}
                        activeOpacity={1}
                    >
                        {children}
                    </TouchableOpacity>
