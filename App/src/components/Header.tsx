...
export default function Header() {
  ...
  return (
    <View className="flex flex-row items-center justify-between h-20 px-4 py-4 rounded-b-3xl bg-card">
      <View className="flex flex-row items-center">
        <View className="flex items-center justify-center h-12 mr-4 rounded-full bg-secondary aspect-square">
        ...
        <PopoverContent className="w-72" align="end" side="bottom" sideOffset={8}>
          ...
          <View className="gap-1 mb-4">
            ...
            <View className="flex flex-row justify-between">
              ...
              <Text className="text-sm">{formatDateLike(user?.createdAt, {format: 'date'})}</Text>
            </View>
            <View className="flex flex-row justify-between">
