...
doplněná o~serverový backend nasazený na adrese
\texttt{lifemeter.fit}.
...
\begin{table}[H]
  ...
  \label{tab:pozadavky}
  \begin{tabular}{|p{5.5cm}|p{1.8cm}|p{6.2cm}|}
    \hline
...
\begin{table}[H]
  ...
  \begin{tabular}{|p{6.5cm}|p{7cm}|}
    ...
    \hline
    Průběžné nasazení
      & GitHub Actions (spouštěno při commitu do větve \texttt{main}) \\
    \hline
    Zdravotní integrace
...
\begin{figure}[H]
  ...
  \begin{minipage}{0.46\textwidth}
    ...
    \caption{Modul tréninku -- aktivní trénink se sadami}
...
Android~14 (Samsung Galaxy S23). Testování se zaměřilo na správnost
