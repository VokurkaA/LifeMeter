...
dokumentací generovanou ve standardu OpenAPI a~produkčním nasazením
na cloudové infrastruktuře s~automatickým průběžným nasazením.
...
Integrace s~platebními nebo předplatitelskými modely by v~případě
komerčního nasazení umožnila financování provozních nákladů serverové
infrastruktury, které v~současné verzi nese autor projektu.
